      ...
      <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
        ...
        >
          ...
          <address className="not-italic">
            <p className="font-sans text-sm leading-loose text-[#2c1a0e]/60">
          ...
          <a
            href="https://maps.app.goo.gl/wy6gsbmtJAFRFPAX8"
            target="_blank"
        ...
        >
          ...
          <iframe
            src="https://maps.google.com/maps?q=36+Saxon+Road,+Sandhurst,+Johannesburg,+South+Africa&t=&z=15&ie=UTF8&iwloc=&output=embed"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
            ...
            title="The Saxon Hotel, Sandhurst"
          />
        </motion.div>
      </div>
    </section>
